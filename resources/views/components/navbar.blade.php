...
<body>
    <nav class="navbar navbar-expand-lg bg-body-secondary pt-2">
        <div class="container">
          ...
          <div class="collapse navbar-collapse mt-1" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class=" btn btn-danger" href="/logout" onclick="return confirm('Yakin ingin lgoout')">Logout</a></li>
                @endauth
                @if (!Auth::check())
